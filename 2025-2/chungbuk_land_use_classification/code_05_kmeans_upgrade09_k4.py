...
pca_outfile = os.path.join(base_dir, "cluster_pca_selected19_area_ratio_pop_k4.png")
...
# 9) 결과 CSV 저장
# =====================================================================
out_csv = os.path.join(base_dir, "chungbuk_clusters_selected19_area_ratio_softmax_pop_k4.csv")
