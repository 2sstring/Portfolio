# -*- coding: utf-8 -*-
"""
Created on Sat Nov 29 01:34:39 2025
...
pca_outfile = os.path.join(base_dir, "cluster_pca_all_area_ratio_pop_k2.png")
...
# 9) 결과 CSV 저장
# =====================================================================
out_csv = os.path.join(base_dir, "chungbuk_clusters_all_area_ratio_softmax_pop_k2.csv")
